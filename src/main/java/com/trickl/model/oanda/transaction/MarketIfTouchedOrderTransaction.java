...
public class MarketIfTouchedOrderTransaction extends Transaction {
  ...
  private final TransactionType type = TransactionType.MARKET_IF_TOUCHED_ORDER; 
  ...
  @JsonPropertyDescription(
      "The price threshold specified for the MarketIfTouched Order. The MarketIfTouched "
              + "Order will only be filled by a market price that crosses this"
              + " price from the direction of the market price at the time when"
              + "the Order was created (the initialMarketPrice). Depending on the"
              + " value of the Order's price and initialMarketPrice, "
  ...
  @JsonPropertyDescription(
      "Specification of which price component should be used when determining if "
              ...
              + " or the \"natural\" trigger side \"DEFAULT\" results in. So for "
              + "a Stop Loss Order for a long trade valid values are \"DEFAULT\""
