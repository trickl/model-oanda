...
@AllArgsConstructor
public class MarketIfTouchedOrderRejectTransaction extends Transaction implements HasInstrument {
  /** The Type of the Transaction. */
  @JsonPropertyDescription("The Type of the Transaction.")
  private final TransactionStreamMessageType type =
      TransactionStreamMessageType.MARKET_IF_TOUCHED_ORDER_REJECT;
