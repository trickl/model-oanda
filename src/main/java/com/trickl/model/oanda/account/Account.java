...
public class Account {
  ...
  @JsonPropertyDescription("The details of the Trades currently open in the Account")
  private List<TradeSummary> trades;

  @JsonPropertyDescription("The details all Account Positions.")
  private List<Position> positions;

  @JsonPropertyDescription("The details of the Orders currently pending in the Account.")
